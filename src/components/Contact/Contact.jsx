...
const Contact = () => {
  ...
  return (
    <motion.div
      ref={ref}
      className="max-w-screen-xl mx-auto h-screen  flex items-center gap-14 px-4 md:px-10 flex-col md:flex-row relative "
      variants={variants}
      initial="initial"
      whileInView="animate"
    >
      <motion.div
        className="flex-1 flex flex-col gap-10 md:gap-5"
        variants={variants}
      >
        <motion.h1
